...
" -------------------------------------------------------------------------------------
let &t_SI = "\e[6q"   " Insert: beam
let &t_EI = "\e[2q"   " Normal: block
let &t_VE = "\e[1q"   " Visual: reverse block (terminal-specific)  
" -------------------------------------------------------------------------------------
...
" -------------------------------------------------------------------------------------
" Remap change window keys | Move between windows with Ctrl-h/j/k/l
" -------------------------------------------------------------------------------------
nnoremap <C-h> <C-w>h
nnoremap <C-j> <C-w>j
nnoremap <C-k> <C-w>k
...
" -------------------------------------------------------------------------------------
" BEGIN: FuzzBox Keyboard mappings
" -------------------------------------------------------------------------------------
